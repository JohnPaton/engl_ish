...
class Language_Model():
    ...
    def word_gen(self,length):
        return word_gen(length, self)

    def sentence_gen(self, length):
        return sentence_gen(length, self)

    def text_gen(self, num_sentences):
        return language_gen(num_sentences, self)
